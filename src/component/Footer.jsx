...
function Footer() {
  return (
    <div className='h-80 flex flex-col justify-center content-center bg-slate-500 mt-10' >
      <h1 className="text-7xl pt-1 w-full mb-2 font-bold text-white text-center animate__animated animate__slideInRight "
